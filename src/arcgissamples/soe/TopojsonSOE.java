...
import json.topojson.api.*;

@ArcGISExtension
@ServerObjectExtProperties(displayName = "Topojson Extension", description = "Provides GeoData as Topojson", defaultSOAPCapabilities = "", allSOAPCapabilities = "", properties = "")
public class TopojsonSOE implements IServerObjectExtension,
	...
	for (int i = 0; i < count; i++) {
		...
		IMapServerDataAccess mapServerDataAccess = (IMapServerDataAccess) this.soHelper
			.getServerObject();
